...
class BabyMonitorConsumer(threading.Thread):
    ...
    def run(self):
        ...
        while self.button_is_pressed:
            print(" [*] BabyMonitor waiting for messages. " +
            ...
            def callback_baby_monitor(ch, method, properties, body):
                ...
                if notif_confirm[0]:
                    print(
                        " [BabyMonitor] Receive Topic: %r | Message: %r \n"
            ...
            self.channel.basic_consume(
                queue=queue_baby_monitor,
                on_message_callback=callback_baby_monitor,
                auto_ack=True,
            )
...
class BabyMonitorProducer(threading.Thread):
    ...
    def run(self):
        ...
        while self.button_is_pressed:
            ...
            print(
                " [BabyMonitor] Sent Topic: %r | Message: %r \n"
